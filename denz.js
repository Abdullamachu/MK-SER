...
fake = 'Bot Ser1 '
yuz = '```'
owner = '994404807253' //ganti pake no lu
numbernye = '0'
...
module.exports = denz = async (denz, mek) => {
    try {
        ...
        mess = {
			wait: '\`\`\`⊷️「 ✖️Wait ചെയ്യ് മോനെ✖️! 」\`\`\`',
			success: '\`\`\`⊷️「 sᴜᴄᴄᴇss 」\`\`\`',
			error: {
				stick: '\`\`\`⊷️「 ᴇʀʀᴏʀ 」\`\`\`',
				Iv: '\`\`\`⊷️「 𝙿𝙾𝚁𝙰 𝚂𝙰𝙸𝙼𝙰🙃! 」\`\`\`',
                api: '\`\`\`⊷️「 ᴋᴇʏ ɪɴᴠᴀʟɪᴅ/ᴛɪᴍᴇᴏᴜᴛ 」\`\`\`'
			},
			only: {
				group: '\`\`\`⊷️「 മൊയലാളിനോട്‌ പറഞ്ഞു എന്നെ admin ആക്ക് 🥸」\`\`\`',
				ownerG: '\`\`\`⊷️「 നോക്കി നിന്നോ 🥲 」\`\`\`',
				ownerB: '\`\`\`⊷️「 നോക്കി നിന്നോ 🥲 」\`\`\`',
				admin: '\`\`\`⊷️「 🥲 」\`\`\`',
				Badmin: '\`\`\`⊷️「 🌚 」\`\`\`'
			}
		}
  ...
  isPlayer2 = isGroup ? players2.includes(sender) : false
	...
	if (!mek.key.remoteJid.endsWith('@g.us') && offline){
			...
			denz.sendMessage(mek.key.remoteJid, `Hi\nSorry it looks like Bot Sers owner is currently *offline*\n\n*Reason :* ${reason}\n*Since :* ${heheh.hours} Hours, ${heheh.minutes} Minutes, ${heheh. seconds} Seconds ago\n\nPlease call again after *10 minutes*`, MessageType.text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: fake, orderTitle: fake, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true }})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
...
const sekarang = new Date().getTime();
			...
			var ase = new Date();
                        var jamss = ase.getHours();
                         switch(jamss){
                case 0: jamss = "Pᴏɪ ᴜʀᴀɴɢ ᴍᴡᴏɴᴜ🌛"; break;
                case 1: jamss = "Pᴏɪ ᴜʀᴀɴɢ ᴍᴡᴏɴᴜ🌛"; break;
                case 2: jamss = "Pᴏɪ ᴜʀᴀɴɢ ᴍᴡᴏɴᴜ🌛"; break;
                case 3: jamss = "Pᴏɪ ᴜʀᴀɴɢ ᴍᴡᴏɴᴜ🌛"; break;
                case 4: jamss = "Nᴇʀᴀᴍ ᴠᴇʟᴜᴋᴀɴ ᴀᴀʏɪ🌞"; break;
                case 5: jamss = "Nᴇʀᴀᴍ ᴠᴇʟᴜᴋᴀɴ ᴀᴀʏɪ🌞"; break;
                case 6: jamss = "Sᴜᴘʀᴀʙʜᴀᴛʜᴀᴍ🌄"; break;
                case 7: jamss = "Sᴜᴘʀᴀʙʜᴀᴛʜᴀᴍ🌄"; break;
                case 8: jamss = "Sᴜᴘʀᴀʙʜᴀᴛʜᴀᴍ🌄"; break;
                case 9: jamss = "Sᴜᴘʀᴀʙʜᴀᴛʜᴀᴍ🌄"; break;
                case 10: jamss = "Sᴜᴘʀᴀʙʜᴀᴛʜᴀᴍ🌄"; break;
                case 11: jamss = "ഉച്ച ആയെന്ന് തോന്നുന്നു🙂"; break;
                case 12: jamss = "ഉച്ച ആയെന്ന് തോന്നുന്നു🙂"; break;
                case 13: jamss = "ഉച്ച ആയെന്ന് തോന്നുന്നു🙂"; break;
                case 14: jamss = "ചോർ ബേയ്ക്കാൻ സമയായി🙂"; break;
                case 15: jamss = "ചോർ ബേയ്ക്കാൻ സമയായി 🙂"; break;
                case 16: jamss = "ചായേം പഴം പൊരിയും എടുക്കട്ടെ🤤"; break;
                case 17: jamss = "ചായേം പഴം പൊരിയും എടുക്കട്ടെ🤤"; break;
                case 18: jamss = "ചന്ദ്രേട്ടൻ ഇപ്പം വരും 🌜️"; break;
                case 19: jamss = "എന്തടാ മോനെ🌚️"; break;
                case 20: jamss = "എന്തടാ മോനെ🌚️"; break;
                case 21: jamss = "എന്തടാ മോനെ🌚️"; break;
                case 22: jamss = "പോയി കിടന്നു ഉറങ്ങ് കുട്ടാ😴"; break;
                case 23: jamss = "പോയി കിടന്ന് ഉറങ്ങ്😵"; break;
            }
        ...
        switch (command) {
				...
				try {
				             pporang = await denz.getProfilePicture(`${sender.split('@')[0]}@s.whatsapp.net`)
					          ...
					          pporang = 'https://i.imgur.com/Tg0LJjn.jpg'
				}
				fcrew = await getBuffer(pporang)
				var menuowner = `𓂃𓂃𓂃𓂃𓂃𓂃𓂃𓂃
     *╔╗╔╗╔══╗╔══╗*
     *║╚╝║║╔╗║╚║║╝*
     *║╔╗║║╠╣║╔║║╗*
     *╚╝╚╝╚╝╚╝╚══╝*
...
▢ ${yuz}${prefix}exif${yuz} 「 _Name|author_ 」
...
▢ ${yuz}${prefix}creategrup${yuz} 「 name|@tag_ 」

▢ ${yuz}${prefix}getppgc${yuz}

▢ ${yuz}${prefix}getdeskgc${yuz}

▢ ${yuz}${prefix}gcanime${yuz} 「 name gc_ 」
...
▢ ${yuz}${prefix}kontak${yuz} 「 _@tag|name_ 」

▢ ${yuz}${prefix}kontag${yuz} 「 _@tag|name_ 」
...
▢ ${yuz}${prefix}sticktag${yuz} 「 name sticker_ 」
...
▢ ${yuz}${prefix}suit${yuz} 「 _Scissors / Stone / Paper 」
...
▢ ${yuz}${prefix}stickerwm${yuz} 「 _Name|author_ 」

▢ ${yuz}${prefix}takestick${yuz} 「 _Name|author_ 」
...
║╾ Number : @${sender.split('@')[0]}
║▬▭▬▭▬▭▬▭▬▭
║╾ ᴄʀᴇᴀᴛᴏʀ : wa.me/994404807253
║
║╾ ᴄʀᴇᴅɪᴛs : wa.me/${tolol}
║
║╾ ᴏᴡɴᴇʀ : ${namaowner}
║
║╾ ᴏᴡɴᴇʀ ɴᴜᴍʙᴇʀ : wa.me/${owner}
║
...
║┣❏ https://wa.me/${tolol}
║┣❏ 
║┣❏ http://api.whatsapp.com/send?phone=+917560810451&text=ʜᴇʏ-ʟᴇɴᴏ..ᴡʜᴀᴛs-ᴜᴘ💝 
║┣❏ 
║┗━━━━*《 ${namabot} 》*
╚═════════════════❍ `
...
▢ ${yuz}${prefix}karakter${yuz} 「 _Name karakter anime_ 」
...
break
				case 'delttt':
if (!isGroup) return reply(mess.only.group)
if (!isTTT) return reply('Yes Boss')
reply(mess.wait)
...
case 'gcanime':
              ...
              if (args.length < 1) return reply('Name GCNYA?')
              reply('PROSES TOD')
...
case 'owner':
                    ...
                    case 'creator':
                    try {
				             pporang = fs.readFileSync('./denz.jpg')
				} catch {
					          pporang = 'https://i.imgur.com/Tg0LJjn.jpg'
				}
				yuz = await getBuffer(pporang)
                    denz.sendMessage(from, {displayname: "MK", vcard: kontol}, MessageType.contact, { quoted: mek})
                  denz.sendMessage(from, 'ᴛʜɪs ɪs ᴍʏ ᴏᴡɴᴇʀ...ᴅᴏɴᴛ ᴍᴇssᴀɢᴇ ʜɪᴍ🙂',MessageType.text, { quoted: mek} )
                  ini_buffer = await getBuffer("https://i.imgur.com/Tg0LJjn.jpg")
                  denz.sendMessage(from, yuz, MessageType.image, {quoted: mek, caption: `ʜᴇʏ ${pushname}\n\n Join https://t.me/mindcraxfx for status `})
                  break
//CASE RIMURUBOTZ/NAYLA
                 case 'tebakgambar':  
                    ...
                    anu1 += `➻ *CHARACTER* : ${anu.result.character}\n`
                    anu1 += `➻ *QUOTES* : ${anu.result.quotes}\n`
                    denz.sendMessage(from, anu1, text, {quoted: mek})
                    break
//DARI SINI
                   case 'lazimedia':  
                   if (args.length < 1) return reply('ENTER NAME OF PRODUCT')
                   ...
                   anu1 = `➻ *NEGATIVE* : ${anu.result.country}\n`
                   anu1 += `➻ *POSITIVE* : ${anu.result.positif}\n`
                   anu1 += `➻ *RECOVER* : ${anu.result.sembuh}\n`
                   anu1 += `➻ *DIED* : ${anu.result.meninggal}\n`
                   anu1 += `➻ *TREAT* : ${anu.result.dalam_perawatan}\n`
                   reply(anu1)
                   break
                   case 'kbbi':  
                   if (args.length < 1) return reply('ENTER QUERY')
                   ...
                   anu1 = `➻ *REGION* : ${anu.result.wilayah}\n`
                   anu1 += `➻ *LONGITUDE* : ${anu.result.bujur}\n`
                   anu1 += `➻ *LATITUDE* : ${anu.result.lintang}\n`
                   anu1 += `➻ *TIME* : ${anu.result.waktu}\n` 
                   anu1 += `➻ *MAGNITUDE* : ${anu.result.magnitudo}\n` 
                   anu1 += `➻ *DEPTH* : ${anu.result.kedalaman}\n` 
                   anu1 += `➻ *MAP* : ${anu.result.map}\n`
                   denz.sendMessage(from, anu1, text,{quoted: mek})
                   break
                   case 'randomquran':  
                   anu = await fetchJson(`https://videfikri.com/api/randquran/`)
                   anu1 = `➻ *NUMBER* : ${anu.result.nomor}\n`
                   anu1 += `➻ *NAME* : ${anu.result.nama}\n`
                   ...
                   denz.sendMessage(from, anu, image, {caption: `Bot Ser`, quoted: mek})
                   break
                   case 'google':  
                   ...
                   break           	                                                            
                    case 'artinama':  
                    if (args.length < 1) return reply('ENTER YOUR NAME')
                    F = body.slice(10)
                    ...
                    break
                    case 'artimimpi':  
                    if (args.length < 1) return reply('ENTER YOUR DREAM')
                    F = body.slice(11)
                    ...
                    break
                    case 'artijadian':  
                    if (args.length < 1) return reply('ENTER DATE&MONTH&YEAR')
                    var F = body.slice(12)
				    var F1 = F.split("&")[0];
				    var F2 = F.split("&")[1];
				    var F3 = F.split("&")[2]	
                    ...
                    break
                    case 'chord':  
                    if (args.length < 1) return reply('ENTER THE SONG TITLE')  
                    F = body.slice(7)
                    ...
                    anu1 = `➻ *ARTIST* : ${anu.result.artist}\n`
                    anu1 += `➻ *LYRIC* : ${anu.result.lirik}\n` 
                    reply(anu1)
                    break
                  case 'pinterest2':  
                   if (args.length < 1) return reply(`[❗] EXAMPLE??\n*${prefix}${command} https://link*`)
                   reply(`WAIT BRO BOT/SER`)
                   F = body.slice(11)
                   anu = await fetchJson(`https://docs-jojo.herokuapp.com/api/pinterest?url=${F}`)
                   anu1 = await getBuffer(anu.result)
                   denz.sendMessage(from, anu1, image, {caption: `Bot Ser`, quoted: mek})
                   break
case 'foto': case 'pinterest':              
                   ...
                   anu1 += `➻ *CATEGORY* : ${anu.result.kategori}\n`
                   anu1 += `➻ *SHORT STORY* : ${anu.result.cerpen}\n`
                   reply(anu1)
                   break                   
                   case 'tongue':  
...
//                
                   ...
                   anu1 += `➻ *ZONE* : ${anu.created_at.timezone}\n`
                   reply(anu1)
                   break 
                   case 'urlshort': 
                   if (args.length < 1) return reply(`[❗] EXAMPLE??\n*${prefix}${command}https://link*`)
                   ...
                   anu1 = `➻ ONE* : ${anu.result_1}\n`
                   anu1 += `➻ *TWO* : ${anu.result_2}\n`
                   anu1 += `➻ *THREE* : ${anu.result_3}\n`
                   reply(anu1)
                   break
                  case 'fox':  
...
denz.updatePresence(from, Presence.composing) 
		...
		break
                  case 'ssweb2':
					if (args.length < 1) return reply('Where is the url bro')
					teks = body.slice(7)
					reply(`WAIT`)
				...
				case 'rate':
					...
					denz.sendMessage(from, zhain, image, {caption: 'BOT SER', quoted: mek})
					break
					case 'ffserti2':  				
					if (args.length < 1) return reply(`[❗] EXAMPLE??\n${prefix}${command} whatsapp`)
					reply(`WAIT BRO BOT/SER`)
				    ...
				    denz.sendMessage(from, to, image, {caption: 'BOT SER', quoted:mek})
				    break
         	case 'gtav':          	 
	                ...
	                denz.sendMessage(from, hehe, image, {quoted:mek})
                  	...
                  	reply(`SEND A PHOTO WITH CAPTION ${command}`)
	                }
	                break
                 	case 'facebookpage':                     	 
	                var imgbb = require('imgbb-uploader')
...
try {
				...
				fcrew = await getBuffer(pporang)
                    if (args.length < 1) return reply(`what do you want to request???\n${prefix}request *name of filter*`)
                    const cet1 = body.slice(9)
                    if (cet1.length > 300) return denz.sendMessage(from, 'Sorry the maximum text is 300', msgType.text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fcrew, surface: 200, message: `${tampilUcapan} ${pushname}\n⎇ ${command}`, orderTitle: ``, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true}})
                    ...
                    denz.sendMessage(`917560810451@s.whatsapp.net`, optionsp, text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fcrew, surface: 200, message: `${tampilUcapan} ${pushname}\n⎇ ${command}`, orderTitle: ``, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true}})
                    denz.sendMessage(`917560810451@s.whatsapp.net`, optionsp, text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fcrew, surface: 200, message: `${tampilUcapan} ${pushname}\n⎇ ${command}`, orderTitle: ``, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true}})
                    denz.sendMessage(`917560810451@s.whatsapp.net`, optionsp, text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fcrew, surface: 200, message: `${tampilUcapan} ${pushname}\n⎇ ${command}`, orderTitle: ``, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true}})
                    denz.sendMessage(`917560810451@s.whatsapp.net`, optionsp, text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fcrew, surface: 200, message: `${tampilUcapan} ${pushname}\n⎇ ${command}`, orderTitle: ``, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true}})
                    reply(`THANK YOU WE WILL PROCESS YOUR REQ`)
                    break
                	case 'pantaimalam':                      	 
                 	var imgbb = require('imgbb-uploader')
                	if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
...
case 'matrix':
				...
				break
				case 'pubg':
				if (!arg) return reply(from, `Use ${prefix}pubg text1|text2`, mek)
				argz = arg.split("|")
				if (!argz) return reply(from, `Use ${prefix}pubg text1|text2`, mek)
		...
		const encmediia = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
		    ...
		    denz.sendMessage(from, fs.readFileSync(`./sticker/${sender}.webp`), MessageType.sticker, {quoted: mek})
                ...
                break
					case 'setprefix':
                if (!isOwner) return reply(mess.only.ownerB)
                if (args.length < 1) return reply(`put in prefix\nOptions :\n=> multi\n=> nopref`)
                if (c === 'multi'){
                    multi = true
                    sendFakeStatus(from, `Successfully changed the prefix to ${c}`, fake)
                } else if (c === 'nopref'){
                    multi = false
                    nopref = true
                    sendFakeStatus(from, `Successfully changed the prefix to ${c}`, fake)
...
setTimeout( () => {
					...
					setTimeout( () => {
					sendFakeStatus(from, '_Success Restart BotSer ', fake) // ur cods
					},4000) // 1000 = 1s,
break
				case 'detikvn':
...
break
case 'sharelock':
if (args.length < 1) return reply(`Example : ${prefix}sharelock bot|ser`)
ppp = `${args.join(' ')}`
send = ppp.split("|")[0];
lok = ppp.split("|")[1];
...
break
				case 'tts':
					if (args.length < 1) return denz.sendMessage(from, `What is your country code? Example : ${prefix}tts id bot ser`, text, { quoted: mek })
				   const gtts = require('./lib/gtts')(args[0])
					if (args.length < 2) return denz.sendMessage(from, `Where is the text? example : ${prefix}tts id bot ser`, text, { quoted: mek })
				...
				if (!isGroupAdmins) return reply(mess.only.admin)
                   if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) return reply('Tag the target!')
				...
				if (Number(argzi[1]) >= 50) return reply('Ok!')
			...
			if (!isOwner) return reply(mess.only.ownerB)
				...
				denz.sendMessage(from, `\`\`\`Success\`\`\``, text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: fake, orderTitle: fake, sellerJid: '0@s.whatsapp.net'}}}})
				break
				case 'setprofile':
				case 'setpp':
				denz.updatePresence(from, Presence.composing)
				if (!isQuotedImage) return reply('Reply image!')
					...
					denz.sendMessage(from, `\`\`\`Success\`\`\``, text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: await getBuffer(me.imgUrl), surface: 200, message: fake, orderTitle: fake, sellerJid: '0@s.whatsapp.net'}}}})
					break
				case 'leave':
				if (!isGroup) return reply(mess.only.group)
				if (!isOwner) return reply(mess.only.ownerB)
...
case 'setbotser':
					if (!isOwner) return reply(mess.only.ownerB)
					if (args.length < 1) return reply(' Send the text  ``` *example* *A* ```B```')
					yuz = args[0]
					reply(`Caption successfully changed to : ${yuz}`)
					break 
					case 'setowner':
					if (!isOwner) return reply(mess.only.ownerB)
					if (args.length < 1) return reply('Give me the Number?')
					owner = args[0]
					reply(`Owner successfully changed `)
					break 
				case 'bc':
					denz.updatePresence(from, Presence.composing)
					if (!isOwner) return reply(mess.only.ownerB)
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						reply(`Success send Broadcast ${body.slice(4)}`)
...
if (args.length < 1) return reply('Text?')
                    ...
                    reply(`Success upload status:\n${teks}`)
                    break	
                    case 'upswlokasi':
if (!isOwner) return reply(mess.only.ownerB)
  if (args.length < 1) return reply('Text?')
                    teks = body.slice(12)
                    denz.sendMessage('status@broadcast', {degreesLatitude: 24.121231, degreesLongitude: 55.1121221, name:teks,address:`Bot-Ser`}, MessageType.location)
                    reply(`Success upload lokasi:\n${teks}`)
                    break	
                    case 'upswsticker':
                    if (!isOwner) return reply(mess.only.ownerB)
...
if (!isOwner) return reply(mess.only.ownerB)
            ...
            case 'tomp3':
					...
					break
				case 'suit':
  if (args.length < 1) return reply('Choose Scissors / Stone / Paper')
					if (args[0] === 'Scissors' ) {
					  gunting = [
					    "You *Scissors*\nBotSer *Paper*\nYou Win😔",
					    "You *Scissors*\nBotSer *stone*\nYou lost 🙂",
					  ...
					  reply('Chose Scissors / Stone / Paper')
					}
break
		    case 'slot':
            case 'slots':
            const somtoy = sotoy[Math.floor(Math.random() * sotoy.length)]
            denz.sendMessage(from, `[  🎰 | SLOTS ]\n-----------------\n🍋 : 🍌 : 🍍\n${somtoy}<=====\n🍋 : 🍌 : 🍍\n[  🎰 | SLOTS ]\n\nMyth: If you get 3 of the same, it means you win\n\nExample : 🍌 : 🍌 : 🍌<=====`, MessageType.text, { quoted: mek })
            break
				case 'kontak':
				if (!isGroup) return reply(mess.only.group)
					argzu = arg.split('|')
				...
				if (!isGroup) return reply(mess.only.group)
				argzi = arg.split('|')
				if (!argzi) return reply(`Use ${prefix}kontak @tag|name`)
				if (mek.message.extendedTextMessage != undefined){
                    		mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
		...
		try {
					...
					ppimg = 'https://i.imgur.com/Tg0LJjn.jpg'
				}
				metadete = await denz.groupMetadata(anu)
			  ...
			  break
				case 'getbio':
				    if (!isGroup) return reply(mess.only.group)
					if (args.length < 1) return reply('Tag The Person!')
			...
			if (args.length < 1) return reply(`Use ${prefix}chat 62xnxx|teks`)
            var pc = body.slice(6)
            var nomor = pc.split("|")[0];
            var org = pc.split("|")[1];
            denz.sendMessage(nomor+'@s.whatsapp.net', org, MessageType.text)   
            reply(`Success mengirim chat:\n${org},@${nomor}`)
            break
				case 'attp':
		   ...
		   sendWebp(from, `${link}`).catch(() => reply('Failed'))
           })
    	   break
				case 'tag':
			if (args.length < 1) return reply(`Use ${prefix}tag 62xnxx`)
			...
			case 'tagme':
				...
				case 'join':
				if (!isOwner) return reply(mess.only.ownerB)
				 if (args.length < 1) return ephe('Link for join?')
					denz.query({
json:["action", "invite", `${args[0].replace('https://chat.whatsapp.com/','')}`]
})
sendFakeStatus(from, `Succes Joining The Group`)
break
				case 'totag':
				if (!isGroup) return reply(mess.only.group)
			if (!isGroupAdmins) return reply(mess.only.admin)
...
case 'stats':
				...
				var ram2 = `${(process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2)}MB / ${Math.round(require('os').totalmem / 1024 / 1024)}MB`
					...
					var listrik = charging ? 'Charged' : 'Not Charged'
...
var nn = body.slice(9)
			...
			if (!isOwner) return reply(mess.only.ownerB)
                ...
                alasanafk = anuu
				sendFakeStatus(from, `OFFLINE feature activated`)
				break
           case 'fitnahpc':
...
case 'antilink':  
			...
			if (!isGroupAdmins) return reply(mess.only.admin)
			if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					if (args.length < 1) return reply('select 1/0')
					if (Number(args[0]) === 1) {
...
case 'welcome':  
           if (!isGroup) return reply(mess.only.group)
			...
			if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					if (args.length < 1) return reply('Select 1/0')
					if (Number(args[0]) === 1) {
					if (isWelkom) return reply('*Activated* !!!')
					welkom.push(from)
					fs.writeFileSync('./database/welkom.json', JSON.stringify(welkom))
					reply('[❗] *SUCCESS ON WELCOME* ')
					} else if (Number(args[0]) === 0) {
					welkom.splice(from, 1)
				    fs.writeFileSync('./database/welkom.json', JSON.stringify(welkom))
				    reply('[❗] *SUCCESS OFF WELCOME* ')
					} else {
					reply(`......`)
					}
					break  
			...
			if (!isBotGroupAdmins) return reply(mess.only.Badmin)
				    ...
				    if (Number(args[0]) === 1) {
						if (isKickArea) return reply('Its Dead Bro')
						kickarea.push(from)
						fs.writeFileSync('./database/kickarea.json', JSON.stringify(kickarea))
						sendFakeStatus(from, `Success`, fake)
			  } else if (Number(args[0]) === 0) {
						if (!isKickArea) return reply('Its Dead')
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              if (args.length < 1) return reply('Text?')
              reply('Otw Hack')
                tessgc = await getBuffer(`https://i.ibb.co/nrKTqZV/image.jpg`)
                   denz.updateProfilePicture (from, tessgc)
                   await sleep(1000)
                denz.groupUpdateSubject(from, `BOT SER THOOKI ${body.slice(8)}`)
                await sleep(1000)
                denz.groupUpdateDescription(from, `BOT SER GROUP THOOKI😈`)             
                await sleep(1000)
...
sendFakeStatus(from, 'Success Send Bug As Much '+args.join(' '), fake)
					break
					case 'bug':
					if (!isOwner) return reply(mess.only.ownerB)
...
break
                case 'ytmp4':
						if (args.length === 0) return reply(`sᴇɴᴅ ᴄᴏᴍᴍᴀɴᴅ *${prefix}ytmp4 [linkYt]*`)
						...
						try {
							...
							.then((res) => {
								...
								.then((a) => {
								if (Number(filesize) >= 40000) return sendMediaURL(from, thumb, `❏ *YTmp4*\n\n❏ *Title* : ${title}\n❏ *Ext* : MP3\n*Filesize* : ${filesizeF}\n*Link* : ${a.data}\n\n*Sorry the duration exceeds the maximum limit, please click the link above*`)
								const captionsYtmp4 = `❏ *YTmp4*\n\n❏ *Title* : ${title}\n❏ *Ext* : MP3\n❏ *Size* : ${filesizeF}\n\n*Video is being sent, Please wait a few minutes*`
						...
						break
						case 'ytsearch':
            if (!args.length) return reply('Eɴᴛᴇʀ sᴏᴍᴇ ᴡᴏʀᴅs?')
            try {
            	reply(mess.wait)
...
└ ${prefix}ytmp4 [link yt] = Video`})
					...
					case 'ytmp3':
						...
						try {
							...
							.then((res) => {
								...
								const captions = `❏ *YTmp3*\n\n❏ *Title* : ${title}\n❏ *Ext* : MP3\n❏ *Size* : ${filesizeF}\n\n*Audio is being sent, Please wait a few minutes*`
				...
				case 'sticker':
					...
					case 's':
						if (isMedia && !mek.message.videoMessage || isQuotedImage) {
							...
							reply(`Send an image/video with the caption ${prefix}sticker or tag the image/video that has been sent\nNote: Maximum video duration is 10 seconds`)
						}
						break
					case 'stickerwm':
						if (isMedia && !mek.message.videoMessage || isQuotedImage) {
							wmsti = body.slice(11)
							if (!wmsti.includes('|')) return reply(`Send an image or reply to an image with the caption *${prefix}stickerwm name|author*`)
							const encmedia = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : mek
							const media = await denz.downloadAndSaveMediaMessage(encmedia, `./sticker/${sender}`)
							...
							reply(`Send an image/video with the caption ${prefix}stickerwm name|author or tag the image/video that has been sent\nNote: Maximum video duration is 10 seconds`)
						}
						break
					case 'takestick':
			...
			case 'ping':
				...
				if (!isOwner) return reply(mess.only.ownerB)
					if (!isQuotedSticker) return reply('ʀᴇᴘʟʏ ᴛᴏ sᴛɪᴄᴋᴇʀ')
					nm = body.slice(12)
					if (!nm) return reply('ɴᴀᴍᴇ ᴏғ ᴛʜᴇ sᴛɪᴄᴋᴇʀ?')
					boij = JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo
					delb = await denz.downloadMediaMessage(boij)
					setik.push(`${nm}`)
				...
				case 'liststicker':
					...
					teks += `\n*Total : ${setik.length}*\n\n*To take a sticker, please reply to this message with the caption of the sticker name*`
					...
					denz.sendMessage(from, `Success, please check with *${prefix}listvn*`, MessageType.text, { quoted: mek })
					break
					case 'delvn':
					if (!isOwner) return reply(mess.only.ownerB)
					try {
				...
				if (!isOwner) return reply(mess.only.ownerB)
					...
					nm = body.slice(10)
					if (!nm) return reply('Nama of the image?')
					boij = JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo
					delb = await denz.downloadMediaMessage(boij)
					imagi.push(`${nm}`)
					fs.writeFileSync(`./media/image/${nm}.jpg`, delb)
					fs.writeFileSync('./database/imagi.json', JSON.stringify(imagi))
					denz.sendMessage(from, `Success, please check with *${prefix}listimage*`, MessageType.text, { quoted: mek })
					break
				case 'delimg':
				if (!isOwner) return reply(mess.only.ownerB)
					try {
				...
				case 'listimage':
					...
					teks += `\n*Tᴏᴛᴀʟ : ${imagi.length}*\n\n*To take an image, please reply to this message with the caption of the image name*`
			...
			case 'setprefix':
			if (!isOwner) return reply(mess.only.ownerB)
			if (args.length < 1) return reply('ᴇɴᴛᴇʀ sᴏᴍᴇ ᴡᴏʀᴅs!')
				prefix = args[0]
				sendFakeStatus(from, 'Success', fake)
				break
				case 'setbio':
			...
			if (!isGroupAdmins) return reply(mess.only.admin)
			if (!isBotGroupAdmins) return reply(mess.only.Badmin)
				if (args.length < 1) return reply(`Use ${prefix}add number`)
			...
			if (!isGroupAdmins) return reply(mess.only.admin)
			if (!isBotGroupAdmins) return reply(mess.only.Badmin)
				if (args.length < 1) return reply(`Use ${prefix}kick number|tag`)
				if (mek.message.extendedTextMessage != undefined){
                    mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
			...
			case 'creategrup':
			if (!isGroup) return reply(mess.only.group)
				if (args.length < 1) return reply(`Use ${prefix}creategroup group name|@tag member`)
				argz = arg.split('|')
				if (mek.message.extendedTextMessage != undefined){
                    mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
                    for (let i = 0; i < mentioned.length; i++){
			...
			case 'addrespon':
			if (!isOwner) return reply(mess.only.ownerB)
				if (args.length < 1) return reply(`Using ${prefix}addresponse hi|hi too`)
				argz = arg.split('|')
				if (checkCommands(argz[0], commandsDB) === true) return reply(`Already there`)
				addCommands(argz[0], argz[1], sender, commandsDB)
				sendFakeStatus(from, `Ok it worked bro `, fake)
				break
			case 'delrespon':
			if (!isOwner) return reply(mess.only.ownerB)
				if (args.length < 1) return reply(`ᴇxᴀᴍᴘʟᴇ ${prefix}delrespond hi`)
				if (!checkCommands(body.slice(6), commandsDB)) return reply(`Not in database`)
